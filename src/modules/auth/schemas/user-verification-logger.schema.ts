...
export const UserVerificationLoggerSchema = SchemaFactory.createForClass(UserVerificationLogger);
export type UserVerificationLoggerDocuement = HydratedDocument<UserVerificationLogger>;