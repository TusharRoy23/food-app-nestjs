...
import { generatePaginatedOrderResponse, generateRawOrderResponseList } from "./order-data";
...
export const getRawOrderResponseList = (n = 1, ...object) => generateRawOrderResponseList(n, object);